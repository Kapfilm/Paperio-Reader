...
Для ручной установки используйте [firmware.bin версии 1.2.1](https://github.com/Kapfilm/Paperio-Reader/releases/download/1.2.1/firmware.bin).
...
Релиз создаётся тегом с номером версии, например `1.2.1`. GitHub Actions прикладывает
`firmware-Paperio-Reader-1.2.1.bin` и совместимую с OTA копию `firmware.bin`.
